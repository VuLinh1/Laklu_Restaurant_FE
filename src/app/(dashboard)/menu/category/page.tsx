...
import DeleteCategory from '@/app/(dashboard)/menu/category/_components/DeteleCategory';
import EditCategoryPopup from '@/app/(dashboard)/menu/category/_components/EditCategoryPopup';
